...
export IBMCLOUD_ACCOUNT_MANAGEMENT_API_ENDPOINT=https://accounts.test.cloud.ibm.com
export IBMCLOUD_USER_MANAGEMENT_ENDPOINT=https://user-management.test.cloud.ibm.com
export IBMCLOUD_UAA_ENDPOINT=https://iam.test.cloud.ibm.com
export IBMCLOUD_ENTERPRISE_API_ENDPOINT=https://enterprise.test.cloud.ibm.com/v1

unset IC_API_KEY
unset IBMCLOUD_IAM_API_ENDPOINT
unset IBMCLOUD_ACCOUNT_MANAGEMENT_API_ENDPOINT
unset IBMCLOUD_USER_MANAGEMENT_ENDPOINT
unset IBMCLOUD_UAA_ENDPOINT
unset IBMCLOUD_ENTERPRISE_API_ENDPOINT

# OLD
# export IBMCLOUD_ACCOUNT_MANAGEMENT_API_ENDPOINT=https://accountmanagement.test.cloud.ibm.com 	
# export IBMCLOUD_CS_API_ENDPOINT=https://containers.test.cloud.ibm.com/global	
# export IBMCLOUD_CR_API_ENDPOINT=https://registry.test.cloud.ibm.com	
...
# export IBMCLOUD_UAA_ENDPOINT=https://login.test.cloud.ibm.com/UAALoginServerWAR	
# export IBMCLOUD_COS_ENDPOINT=https://s3.eu-de.cloud-object-storage.test.appdomain.cloud	
